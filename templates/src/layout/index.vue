                ...
                <a-layout-header class="header clearfix">
                    <a-row>
                        ...
                        <a-col :span="13" class="textR">
                            <a-space>
                                <img @click="gotoGithub" style="width: 20px" src="@/assets/github.png" alt="" />
                                <a-popover>
                                    <template slot="content">
                                        <img src="@/assets/zuozhe.jpeg" alt="" width="80" />
                                    </template>
...
export default {
    ...
    methods: {
        ...
        gotoGithub() {
            window.open('https://github.com/wuba/Antenna', '_blank')
        },
        logout() {
